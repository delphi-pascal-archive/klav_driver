...
; а также добавляющий символ "тире" после каждой буквы "M", следующей
; за "m" ("mM-")
...
tire proc near		; Вывод '-' после 'mM':
xor	al,'M'		; Последний символ 'M'?
...
initial endp
msg1 db '<<< Console driver [by Kalgushkin Denis, IT-4 (2)] >>>',0dh,0ah,'$'
console endp
Code ends
End start